...
class BookingController extends AbstractController
{
    ...
    public function createBooking(Request $request): JsonResponse
    {
        ...
        if (!isset($data['house_id']) || !isset($data['phone'])) {
            throw new HttpException(Response::HTTP_BAD_REQUEST, 'Missing required field: house_id or phone!');
        }
    ...
    public function updateBookingComment(int $id, Request $request): JsonResponse
    {
        ...
        if (!isset($data['comment'])) {
            throw new HttpException(Response::HTTP_BAD_REQUEST, 'Missing required field: comment!');
        }
    ...
    public function deleteBooking(int $id): JsonResponse
    {
        try {
            ...
            if (!$booking) {
                throw new HttpException(Response::HTTP_NOT_FOUND, "Booking with id {$id} not found");
            }
